...
public class ChatbotController {
    ...
    public ResponseEntity<String> chatbot(@RequestParam(required = false) String userCode, @RequestBody Map<String, Object> payload) {
        try {
            ...
            String url = "http://otoo-load-balancer-fastapi-571007349.ap-northeast-2.elb.amazonaws.com:8001/chatbot";
    ...
    public ResponseEntity<String> emotionReport(@RequestBody Map<String, Object> payload) {
        try {
            ...
            String url = "http://otoo-load-balancer-fastapi-571007349.ap-northeast-2.elb.amazonaws.com:8001/emotionReport";
            HttpHeaders headers = new HttpHeaders();
            headers.setContentType(MediaType.APPLICATION_JSON);
